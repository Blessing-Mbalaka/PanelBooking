...
urlpatterns = [
    ...
    path("api/settings/unlock/", views.unlock_settings, name="unlock-settings"),
    ...
    path("api/bookings/<int:booking_id>/admin-cancel/", views.admin_cancel_booking_view, name="admin-cancel-booking"),
